...
int EN_Mtr2_1,EN_Mtr1_1; // Position of Motors at Location A 
int EN_Mtr2_2,EN_Mtr1_2; // Position of Motors at Location B
...
void GetCoordinatesA() {
     ...
     Serial.println(EN_Mtr1_1, EN_Mtr2_1);
...
void GetCoordinatesB() {
     ...
     delay(2000);
     Serial.println("Rotation for Motor1 and 2 is");
     Serial.println(EN_Mtr1_2, EN_Mtr2_2);
...
void execute (){
      ...
      //Open Claw
      evshield.bank_b.motorRunDegrees(SH_Motor_1, SH_Direction_Forward,SH_Speed_Slow,50, SH_Completion_Wait_For, SH_Next_Action_BrakeHold);
      delay(2000);
     if (EN_Mtr2_2<0)
     ...
     delay(2000);
     //Close Claw
     evshield.bank_b.motorRunDegrees(SH_Motor_1, SH_Direction_Reverse,SH_Speed_Slow,50, SH_Completion_Wait_For, SH_Next_Action_BrakeHold);
